...
<div
				...
				>
					<div class="ve-w-100 ve-split-v-center">
						<div class="ve-flex-v-center ve-self-flex-stretch ve-w-100 ve-min-w-0">
							<span class="ve-rd__data-embed-name ve-hidden" data-rd-data-embed-name="true">Elven Trinket</span>
			...
			<td colspan="6" data-rd-tag="item" data-rd-uid="Elven Trinket|MTF" data-rd-page="items.html" data-rd-source="MTF" data-rd-hash="elven%20trinket_mtf" data-rd-name="Elven Trinket" data-rd-display-name="Elven Trinket" data-rd-style="" data-rd-entry-data="{}" data-rd-slot-size="small" data-rd-is-fixed-height-initial="true">
				<i>Loading &quot;<a href="items.html#elven%20trinket_mtf"  onmouseover="Renderer.hover.pHandleLinkMouseOver(event, this)" onmouseleave="Renderer.hover.handleLinkMouseLeave(event, this)" onmousemove="Renderer.hover.handleLinkMouseMove(event, this)" onclick="Renderer.hover.handleLinkClick(event, this)" onwheel="Renderer.hover.handleLinkWheel(event, this)" ondragstart="Renderer.hover.handleLinkDragStart(event, this)" data-vet-page="items.html" data-vet-source="MTF" data-vet-hash="elven%20trinket_mtf" ontouchstart="Renderer.hover.handleTouchStart(event, this)" >Elven Trinket</a>&quot;...</i>
