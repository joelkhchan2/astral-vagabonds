...
<div
				...
				>
					<div class="ve-w-100 ve-split-v-center">
						<div class="ve-flex-v-center ve-self-flex-stretch ve-w-100 ve-min-w-0">
							<span class="ve-rd__data-embed-name ve-hidden" data-rd-data-embed-name="true">Chaotic Planar Encounters</span>
			...
			<td colspan="6" data-rd-tag="table" data-rd-uid="Chaotic Planar Encounters|MPP" data-rd-page="tables.html" data-rd-source="MPP" data-rd-hash="chaotic%20planar%20encounters_mpp" data-rd-name="Chaotic Planar Encounters" data-rd-display-name="Chaotic Planar Encounters" data-rd-style="" data-rd-entry-data="{}" data-rd-slot-size="medium" data-rd-is-fixed-height-initial="true">
			...
			>
				...
				>
					<div class="ve-w-100 ve-split-v-center">
						<div class="ve-flex-v-center ve-self-flex-stretch ve-w-100 ve-min-w-0">
							<span class="ve-rd__data-embed-name ve-hidden" data-rd-data-embed-name="true">Evil Planar Encounters</span>
							<span class="ve-rd__data-embed-name-expanded ve-text-right ve-pr-2 ve-w-100 ve-h-100 " data-rd-data-embed-name-expand="true"></span>
						</div>
				...
				<div class="ve-rd__wrp-embedded-data-table  ve-overflow-y-auto ve-flex-vh-center" data-rd-rendered-data-embed-content="true">
					<table>
						<tbody data-rd-rendered-data-embed-render-target="true"><tr>
			<td colspan="6" data-rd-tag="table" data-rd-uid="Evil Planar Encounters|MPP" data-rd-page="tables.html" data-rd-source="MPP" data-rd-hash="evil%20planar%20encounters_mpp" data-rd-name="Evil Planar Encounters" data-rd-display-name="Evil Planar Encounters" data-rd-style="" data-rd-entry-data="{}" data-rd-slot-size="medium" data-rd-is-fixed-height-initial="true">
			...
			>
				...
				>
					<div class="ve-w-100 ve-split-v-center">
						<div class="ve-flex-v-center ve-self-flex-stretch ve-w-100 ve-min-w-0">
							<span class="ve-rd__data-embed-name ve-hidden" data-rd-data-embed-name="true">Good Planar Encounters</span>
							<span class="ve-rd__data-embed-name-expanded ve-text-right ve-pr-2 ve-w-100 ve-h-100 " data-rd-data-embed-name-expand="true"></span>
						</div>
				...
				<div class="ve-rd__wrp-embedded-data-table  ve-overflow-y-auto ve-flex-vh-center" data-rd-rendered-data-embed-content="true">
					<table>
						<tbody data-rd-rendered-data-embed-render-target="true"><tr>
			<td colspan="6" data-rd-tag="table" data-rd-uid="Good Planar Encounters|MPP" data-rd-page="tables.html" data-rd-source="MPP" data-rd-hash="good%20planar%20encounters_mpp" data-rd-name="Good Planar Encounters" data-rd-display-name="Good Planar Encounters" data-rd-style="" data-rd-entry-data="{}" data-rd-slot-size="medium" data-rd-is-fixed-height-initial="true">
			...
			>
				...
				>
					<div class="ve-w-100 ve-split-v-center">
						<div class="ve-flex-v-center ve-self-flex-stretch ve-w-100 ve-min-w-0">
							<span class="ve-rd__data-embed-name ve-hidden" data-rd-data-embed-name="true">Lawful Planar Encounters</span>
							<span class="ve-rd__data-embed-name-expanded ve-text-right ve-pr-2 ve-w-100 ve-h-100 " data-rd-data-embed-name-expand="true"></span>
						</div>
				...
				<div class="ve-rd__wrp-embedded-data-table  ve-overflow-y-auto ve-flex-vh-center" data-rd-rendered-data-embed-content="true">
					<table>
						<tbody data-rd-rendered-data-embed-render-target="true"><tr>
			<td colspan="6" data-rd-tag="table" data-rd-uid="Lawful Planar Encounters|MPP" data-rd-page="tables.html" data-rd-source="MPP" data-rd-hash="lawful%20planar%20encounters_mpp" data-rd-name="Lawful Planar Encounters" data-rd-display-name="Lawful Planar Encounters" data-rd-style="" data-rd-entry-data="{}" data-rd-slot-size="medium" data-rd-is-fixed-height-initial="true">
			...
			>
				...
				>
					<div class="ve-w-100 ve-split-v-center">
						<div class="ve-flex-v-center ve-self-flex-stretch ve-w-100 ve-min-w-0">
							<span class="ve-rd__data-embed-name ve-hidden" data-rd-data-embed-name="true">Neutral Planar Encounters</span>
							<span class="ve-rd__data-embed-name-expanded ve-text-right ve-pr-2 ve-w-100 ve-h-100 " data-rd-data-embed-name-expand="true"></span>
						</div>
				...
				<div class="ve-rd__wrp-embedded-data-table  ve-overflow-y-auto ve-flex-vh-center" data-rd-rendered-data-embed-content="true">
					<table>
						<tbody data-rd-rendered-data-embed-render-target="true"><tr>
			<td colspan="6" data-rd-tag="table" data-rd-uid="Neutral Planar Encounters|MPP" data-rd-page="tables.html" data-rd-source="MPP" data-rd-hash="neutral%20planar%20encounters_mpp" data-rd-name="Neutral Planar Encounters" data-rd-display-name="Neutral Planar Encounters" data-rd-style="" data-rd-entry-data="{}" data-rd-slot-size="medium" data-rd-is-fixed-height-initial="true">
			...
			</div>![](img/book/MPP/008-00-017.morte-meet-dragon.webp)
