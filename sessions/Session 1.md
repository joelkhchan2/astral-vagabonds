...
4. **Plant three seeds** for the Guttering, played as mild unease, never alarm (see "Seeds" below).
...
**0. Opening flashback: the boot camp.** Before the title, run a short playable flashback of the day Orena and Aerion met at Vaelren Windsong's training camp: a paired obstacle wall (Aerion throws Orena over it; Athletics/Acrobatics, teamwork is the lesson), a light nonlethal bout against a rival pair, and a lights-out bunk scene for chemistry. Then hard-cut to the present crew mid-rhythm and up onto the Rock. It plants the friendship and hints at a history so the pilot feels lived-in. **Full scene and script in the session-1 companion (§00).** Player agency holds: offer the beats, never script the two leads.
...
**3. Transit -- one event.** Pick *one* piece of cosmic content (don't overload session 1), and add a short fight if Gabrielle wants combat. Rotate the wonder each session -- the sky is full of strange things, not just whales:
   - **Wonder options (default: the chwinga astronaut, fully written in the companion §06):** a **chwinga "astronaut" fishing off the bow from the back of a space guppy**, casting a line into the void for something only it can see; a derelict with the table still set and no crew; a **mercane** vessel passing on business older than the cartel; a shoal of space guppies that adopts the ship; or, used *sparingly*, a distant **kindori** pod singing by light (awe, and a pull Orena can't place -- save the heavy whale beats for later so they stay special).
...
**6. The cold open (the point of the whole session).** Night, ship quiet, heading home. Orena alone on watch, updating her charts. A constellation she steers by is *wrong* -- off by a hair. She rechecks her instruments twice; the instruments are fine, the sky is wrong. And as she watches, one star, dimming, **goes out.** No sound -- except, if she strains, the faint edge of a note she has heard exactly once before, the night she lost her crew. She doesn't tell anyone yet. **Cut to black. End of session.**
...
Session 2+ is more of the same voyage loop with the pattern thickening (more dark routes, more whales, Meech's "three frontier routes delisted with no incident reports" if a player is polite to him). Tier 1's job is to accumulate symptoms into a pattern the crew *notices* -- and to let Orena's private thread start pulling them toward the edge. The full Tier 1 shape is in `campaign/Story Spine.md`.
