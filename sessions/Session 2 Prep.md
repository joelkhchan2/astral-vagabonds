...
- **The crew is 345th of 350, not 348th of 351.** Part vacancy (the *Grendel's Wake* is gone from the Board entirely, destroyed at Reefside), part earned climb from completing Sealed and Sworn. See `factions/The Manifest Board.md`.
...
- **Reefside hasn't outrun them home.** They're arriving at Bral roughly as fast as the news could, so whatever the dockside eventually says about it, the crew is close to the first real account to reach port, not the last to hear a warped version of their own story. Good texture the other direction: a regular at the Compass Rose or Sprat catching wind of *something* happening out past the Verge and pressing the crew for details. What they choose to say, downplay, or leave out is what starts shaping the story everyone else eventually tells. Their call, not a fait accompli.
- **The Manifest Board update lands as a public moment, not just a paper fact.** 348th to 345th, posted at the Charter Window, part vacancy (the *Grendel's Wake* gone) and part earned climb from Sealed and Sworn. Worth watching Estra read it as a real, mixed beat, some of this she earned, some of it she was handed. Finny throws a party regardless of which part he understands (`factions/The Manifest Board.md`).
...
- **A small, unsigned tremor from Vellum.** Not a visit, not an accusation, just two words on a plain slip of paper that turns up somewhere it shouldn't, tucked into the ship's mail at berth, waiting on Aerion's ledger, slid under a door: **"WE KNOW."** No signature, no further detail, nothing to act on. GM-side truth: it's Vellum's quiet watch testing a reaction, not the real conversation (that's still keyed to the crew's *next* completed contract per `campaign/Story Spine.md`). Play it for a genuine chill and then let it sit there, unresolved. Don't confirm it's Vellum at the table unless someone works it out.
