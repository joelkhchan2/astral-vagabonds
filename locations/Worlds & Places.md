...
Actual destinations, arranged by region. Home port is in `The Bral Reach.md`; the regions themselves are in `Houses & Holdings.md`.

Every entry follows the house format: **one secret, one danger, one opportunity.** Sensory detail first, because in this setting sound, light, texture, gravity, and psychic residue are how a place tells you what it is.

**Canon:** systems are named for their defining world (Realmspace, Doomspace, Xaryxispace) and the rules explicitly invite you to invent your own. All of the below is ours.
...
## OSTERGALE
**Chain world, agricultural, ancient.** The house world of the Sallow Chain and the reason the corridor exists.

Endless terraced grain, gold to the horizon, under a sun that has been described as "reliable" in official documents for two hundred years. The light is flat and even. Nothing here has changed in living memory and the residents consider this an achievement.

**Secret:** Ostergale's yields have declined 4% a year for six years. The Chain houses have absorbed it quietly rather than investigate, because the alternative is admitting a current is thinning at the *core*.
**Danger:** none, and that's disarming. The danger is that the crew relax.
...
## THE SPINDLE WRECKS
**A debris field** where two currents shear against each other and have been depositing ships for six hundred years.

Hulls at every angle, none of them agreeing on which way is down, and the gravity planes of the larger wrecks still functioning enough to flip a boarding party mid-step. Metal groans. Something in the field pings, regularly, and nobody has found what.
...
Everything is lit from one side. Long shadows that never move. Nine hundred people, one dock, one bar, and a mine that's been three years from exhaustion for a decade.
...
Ice walls sweating under work lamps. Meltwater runs in channels down every corridor. Warm inside, freezing everywhere else, and it smells of wet rock and cooking.

**Secret:** the Anchorage's harbourmaster keeps better navigation records than the CIV, because out here bad data kills you. She will trade them, for something.
**Danger:** no law means no law. Brass's neogi problem could walk in.
**Opportunity:** the aftermarket table lives here. False holds, spoofers, ghost registries, and the people who fit them.

## SEVENTY-ONE
**A colony that isn't there any more.** A survey designation rather than a name, on a route delisted last year with no incident report.

Arriving is the scene. The system is *right*. The star is right, the planet is right, and the settlement is four hours off from where every chart in existence says it is, sitting perfectly intact with two hundred people living in it who are baffled by the question.

**Secret:** it isn't the colony that moved.
**Danger:** none, and the absence of danger is the horror. Nothing is wrong. The arithmetic is wrong.
**Opportunity:** the single most valuable anomaly report the crew can file in Tier 1.
...
## THE LISTENING SHOAL
**A drift of resonant crystal**, kilometres across, that hums.

Approach in silence and the hull rings. Every ship rings at a different pitch. Old spacers navigate by it and can't explain how. The light through it is green-gold and moves.
...
## THE CARTÓGRAPHA
**The Board of Ledgers' archive-station**, a hollowed private asteroid one day's sail from the Rock. Entry by invitation only.

Warm stone, soft light, absolute quiet. Every route the Pale Reach owns is filed here. The Board chamber has five founding chairs and **the fifth is empty and dusted weekly.**

**Secret:** the fifth chair belongs to House Carrow, and the reason it's empty is the reason the crew's whole campaign exists.
**Danger:** getting in is trivial with an invitation and impossible without one.
**Opportunity:** Tier 3.

## THE ROOKERY
**A shanty ring** clamped to the Rock's underside where crews who can't afford berth fees live between contracts.

Improvised, crowded, and warmer than it looks. Laundry lines in null-gravity. Everyone knows everyone. This is where Brass's contacts live and where a scattered crewmate could plausibly have washed up.

**Secret:** three separate people here are hiding from the neogi and none of them know about the others.
**Danger:** it is one bad decompression from a mass casualty and everyone knows it.
**Opportunity:** crew, contacts, rumour, and cheap labour that owes you.
...
Six regions, thirteen places. That's enough to run to level 10 without inventing anything under pressure.

When you need a new one: pick the region, decide whether it's **thriving, thinning, or gone**, and give it one secret, one danger, one opportunity. On the Verge, always at least one of them should be arithmetic that doesn't work.
