...
Deferred from Session Zero — to be built out later using the D&D 2024 Bastion rules (the ship *is* the party's bastion / home base). Two facilities at level 5, two more at 9, one at 13, one at 17, pooled between both PCs. Free in gold; you pay only to enlarge.
...
- **Gun bay:** ammunition storage; the nightly loading ritual happens here.
...
## Crew aboard (the loyal survivors)

The five who stayed after the old ship blew and the rest lost faith and left, plus the two PCs. Full writeups belong in `npcs/`; here's who lives aboard and what they do.
