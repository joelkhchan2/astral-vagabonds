...
Who owns what, where, and worth how much. `The Pale Reach.md` covers the institution and its politics; this is the economic and geographic layer underneath it.

**Canon anchors:** the **Rock of Bral** is a mile-wide asteroid city founded roughly 200 years ago by the pirate Captain Bral, and 5e deliberately never fixes its location. Wildspace systems are named for their defining world (Realmspace, Doomspace, Xaryxispace) and the rules explicitly invite you to invent your own. **Everything below the Rock is ours.**

A useful coincidence to use: **the Pale Reach was founded roughly 200 years ago too.** Bral became a real port and the cartographer families incorporated within a generation of each other. The port created the trade, and the trade created the cartel.

---

# 1. READING THE MONEY

Anchor everything against the crew. **Their entire venture is 50,000 gp.**

| Tier | Net worth |
|---|---|
| Founding house | 29–84 million gp |
| Major member house | 3–15 million gp |
...
The youngest founding house at roughly eighty years, and the poorest. They are outvoted on everything and increasingly loud about it.
...
The official account is mismanagement. Vellum's position is that Carrow overextended into worthless space and paid for it, and the formal mechanism behind that story is a real, boring Archive policy: a corridor's public chart listing lapses automatically when its originating charter-holder's operating certification lapses, and Carrow's certification lapsed during its own restructuring. That's the line Vellum can give a Board inquiry or a rival house and have it hold, ordinary housekeeping, no admission attached.

> **It also runs the causality backward, and the paper to prove it is sitting in the crew's hold.** The crew's lockbox (`campaign/Story Spine.md`, "What session 1 already changed") holds a Registrar's plea describing the Amberwake failing on its own, years before Carrow's certification lapsed, and the corridor's own working chart, corrected repeatedly across that same stretch. Line the two up and the order of events flips: the corridor didn't die because Carrow's business collapsed, Carrow's business collapsed because the corridor died first and took the settlements with it. Vellum's official story survives only for as long as nobody puts those two dates side by side. Vellum didn't cause Carrow's fall. It watched the corridor fail in real time, said nothing, and quietly bought up Carrow's abandoned routes and contracts while backing the "mismanagement" story in public, profiting from being the only house that knew what actually happened and letting Carrow take the blame alone.
...
**Sources:** [Rock of Bral, AAG](https://www.dndbeyond.com/sources/dnd/sais/aag) · [Wildspace systems](https://www.dndbeyond.com/posts/1238-the-spelljammers-guide-to-wildspace-in-dungeons)
