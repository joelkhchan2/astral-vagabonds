...
- **331. *Fair Return*:** Cutter-class, captained by **Marlow Aldous**, human, fifties, a small, professional escort-and-courier outfit, nine crew normal complement, **five now**, four lost over the past month, none of it to violence (a poaching, a homesickness, a teleportation mishap, and a runaway who joined a travelling troupe, see `sessions/Session 3 Prep.md`). **Met in session 3** (Two Chairs Short): sought out the *Night Fury* specifically, on reputation rather than rank, for the second hull Stoneward's escort licensing requires. **Voice tic:** contract language even off the clock, "acceptable terms," "within scope." **Physical tic:** checks the manifest even when he already knows what's on it. First named example of the campaign's own standing theme (the Board's number isn't the real measure) landing from someone *above* the crew rather than below it. Worth deciding within a session or two whether he grows into a recurring warmer face at this rank tier, similar in shape to the *Long Odds* below, or stays a one-job thread.
