# Astral Vagabonds - Campaign Bible

## The Pitch
A motley crew aboard a battered spelljammer takes odd jobs across Wildspace -- salvage, courier runs, bounty work -- while running from their pasts and slowly becoming the only family they've got. Firefly meets Brooklyn Nine-Nine in the Astral Sea. The frontier is infinite, the law is thin, and everyone on this ship has a reason they can't go home.

## Setting Overview

### Wildspace
Wildspace systems are the equivalent of solar systems -- planets orbiting suns, with void between them. Ships travel at 100 million miles per day in open Wildspace. When approaching anything with its own gravity/air envelope, ships drop to tactical speed (25-50 ft/round).

### The Astral Sea
The silvery medium all Wildspace systems float within, like islands in an ocean. Ships sail far enough out from a Wildspace system and transition into the Astral Sea. From there, navigate to any other system. Time, distance, and physics behave strangely here. Thought can influence reality. Memory leaves residue.

### Air Envelopes & Gravity
Every ship drags a bubble of breathable air. A ship's envelope extends outward from all surfaces equal to the ship's longest dimension. Air stays breathable for ~120 days for a crew complement, then goes foul (disadvantage on checks), then unbreathable. Every spelljammer generates a gravity plane bisecting the vessel horizontally -- above pulls down, below pulls up. The underside of a deck is walkable.

### The Concordance of Independent Ventures (CIV)
The dominant licensing body for legitimate Wildspace operations. A cross between a merchant marine registry, a freelancer guild, and a credit rating agency. You need a CIV charter to dock at major ports, bid on contracts, buy fuel at market rate, or avoid being shot by patrol frigates.
...
**Genre blend:** Fantasy pirate adventure + retro sci-fi camp + Age of Sail exploration + western frontier + light cosmic eeriness. The setting's signature move is tonal whiplash deployed deliberately: negotiating port fees one minute, screaming cosmic anomaly the next.
...
**Campaign scope:** Levels 5-20. As many sessions as that takes. Systemic/factional antagonists rather than a single main villain -- the "enemy" shifts as the crew moves through tiers of play.
...
**The truth:** the Astral is a living ocean, and the roads are a living ecosystem. Great whales (**kindori**) graze and circulate the ambient radiance (**the Shine**) that keeps systems lit and findable; their apex predator (**void scavvers**) kept the whales migrating. Civilization exterminated the predators, so the whales overpopulate and stop migrating, overgraze the Shine, and regions **gutter out** -- cut off, not destroyed. It's a trophic cascade *we* caused, and it's reversible. The cure is learning to move *with* the living sky (a nomadic, un-tollable navigation), not to own it.
...
- Both PCs get distinct, meaningful spotlight moments every session
- NPC crew members carry B-plots and grow over time
- Mysteries have multiple solution paths (skill checks, magic, roleplay, deduction)
- Combat is narratively justified, not filler
- Sitcom rhythm: setup, escalation, punchline or emotional beat
- The quiet moments matter as much as the action scenes
- Workplace comedy energy: the humor is in the daily grind of running a ship with these specific weirdos
