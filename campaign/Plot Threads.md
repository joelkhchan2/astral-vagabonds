...
- **Orena (Gabrielle):** her guild, the Wayfinder Knot, chased the Stillwater Vocalise (a kindori death-song) on an ordinary Material Plane sea and got pulled through a thin place between it and the Astral. Updated, full account in `npcs/The Wayfinder Knot.md`: four of the five survived together and built their own charter crew, the *Steady Line*; Orena alone was scattered from them and neither side knows the other made it. The reunion is a mid-campaign rumor-driven event, not gated behind mastering the living sky the way the world-plot is.
...
## Character-Level: The Vane Compact Rebuild
Estra is quietly rebuilding her destroyed fleet from rank 348. Every job charts a route. Every crew member was chosen for a reason.

**Key reveal:** Mid-campaign, crew discovers they were selected, not randomly hired. Tests found-family bond.

**Compact captain arcs (7 total, including Estra):**
- 2 dead (investigation arcs -- what happened? who ordered it?)
...
## The Broker's Favors
Two favors remain from Estra's deal. The Broker is a **faceless force** -- operates only through intermediaries, dead drops, and proxied instructions. Never appears on screen. The dread is in never knowing who's working for them or when the next favor arrives.

**Favor #2 possibilities:**
- Deliver something morally repugnant
- Betray a port or faction the crew has come to care about
- Hand over a crew member (the Broker wants someone specific)
...
**Priscilla's family awareness:** In contact but not closely. They know roughly where she is, but only what she tells them. She controls the dial, though they may have other sources.

---

## Orena's Lost Crew (the Wayfinder Knot)

> **Superseded, full current canon in `npcs/The Wayfinder Knot.md`.** Kept here only as a pointer.

Her guild were ordinary Sword Coast navigators, still entirely on the Material Plane, who went chasing an old sailors' legend for the thrill of it: the **Stillwater Vocalise**, a **death-song**, the drawn-out dirge of a starving, stranded kindori pod as its water went dark, a sound that does not stop when the whale does. A dying pod drifts toward the nearest thin place between the Tide and anywhere else water exists, the way a real dying whale beaches itself; the Knot found one mid-death. The pod's final pulse tore the crossing open and pulled the ship through whole. Orena, at the rail rather than fixed to the hull, went down a different thread of the pull and came out alone. **The other five survived too**, together, and rebuilt into their own charter crew, the *Steady Line* (~rank 99), with no idea whether Orena made it. Neither side has found the other since, the crossing point wasn't a place, it was an event tied to a pod that has since finished dying.
