...
Chief Engineer (and Gunner). Autognome, a small cheerful construct. Meticulous, literal, and endlessly devoted to the ship, which he treats the way a person treats a beloved giant dog.
...
Tack was built by **Old Marrow**, the last working master of the **Threadneedle line**, a small rock-gnome shipwright house that hand-built autognomes the old way, one at a time, tuned to a specific hull rather than mass-produced to a spec sheet. Marrow built him to crew the ***Lodestar Covenant***, a five-hundred-person exploration galleon, and told him, the day he was switched on, that a ship that size needs a mind small enough to check every rivet and patient enough to love every one of them. Tack believed that completely and has never stopped.

He served the *Lodestar Covenant* for **eleven years** under a captain named **Idris Fane**, who let him name every deck fitting from the day he came aboard and never once corrected him for talking to the hull. When the *Covenant* was decommissioned, not destroyed, just aged out and sold for parts after Fane retired, Tack asked to go with the scrap. He was told, not unkindly, that autognomes don't get retirement postings, they get reassigned. He spent **four years bouncing between short charters and skeleton crews**, never long enough on any one hull to name its parts before he was moved again, before he landed a berth on Estra's previous ship. That ship blew up within the year. He has now been "reassigned" away from two homes and lost one to fire; this is why "will they keep me" isn't paranoia for Tack, it's a documented pattern he's lived twice already, and why this hull, and this crew choosing to keep him after the last one burned, is the first time in fifteen years the answer's actually been yes.

**Old Marrow is still alive**, working a much smaller yard now that the Threadneedle line has mostly been bought up (see "Creator loyalty," below). Tack writes to him twice a year, cheerful, newsy letters about the ship's condition that never once mention how he's actually doing. Marrow always writes back the same four words: *"Keep her running true."* Tack has kept every single reply.
...
## Creator loyalty (the secret and its trigger)
Tack was made by the **Threadneedle line**, a small rock-gnome shipwright house, since mostly bought up by a Pale Reach-aligned concern that kept the name for the prestige and gutted the actual practice. Old Marrow held onto a much smaller independent corner of it, but the original contracts, and the paperwork on every autognome the full line ever built, went with the sale. On paper, that raises an ugly question the crew has never had to face: an autognome built under a company contract may still be, in the eyes of that company, an **asset** rather than a person. Somewhere in a Pale Reach-aligned filing cabinet is Tack's make and serial number, and Old Marrow's signature on the build order that made him.
