...
**Design principle:** the crew are professionals, not adventurers. Most sit between CR 1/4 and CR 3. Each one has exactly one thing they are genuinely excellent at, and that thing is usually not violence.
...
***The Morning Roll.*** She is the cook too. Each morning she is on breakfast, roll a **d20** for the day's food (1–5 Bad, 6–15 Fine, 16–20 Good), then a second d20 on that table for the dish and its effect. Bad dishes call for a Con save. Full tables: `The Galley.md`.
...
***Rapier.*** *Melee:* +7 to hit, reach 5 ft. *Hit:* 8 (1d8 + 4) piercing.
***Hand Crossbow.*** *Ranged:* +7 to hit, range 30/120. *Hit:* 7 (1d6 + 4) piercing.

***Desperate (1/Day).*** When reduced below half hit points, he immediately takes an additional action and gains 20 temporary hit points.

**Reactions**
***Parry.*** +3 AC against one melee attack he can see.

> **He never fights alone.** His hull carries fifteen. Run him with six to ten crew or the encounter misrepresents him entirely.
...
| STR | DEX | CON | INT | WIS | CHA |
|---|---|---|---|---|---|
| 14 (+2) | 20 (+5) | 18 (+4) | 14 (+2) | 14 (+2) | 16 (+3) |

**Saving Throws** Dex +8, Wis +5
**Skills** Acrobatics +8, Athletics +5, Insight +5, Perception +5, Persuasion +6, Stealth +8
**Senses** darkvision 60 ft., passive Perception 15 · **Proficiency Bonus** +3

***Evasion.*** On a Dex save for half damage, he takes none on a success and half on a failure.
...
**Actions**
***Multiattack.*** Three attacks.
***Elven Longblade.*** *Melee:* +8 to hit, reach 5 ft. *Hit:* 9 (1d8 + 5) slashing.
***Dagger.*** *Melee or Ranged:* +8 to hit, range 20/60. *Hit:* 7 (1d4 + 5) piercing.

***Sneak Attack (1/Turn).*** +10 (3d6) damage when he has advantage or an ally is adjacent.

**Reactions**
***Intervention (1/Day).*** When an ally within 5 feet is hit, he redirects the attack to himself.
...
If a scene genuinely collapses into combat, use **Noble** (CR 1/8) or **Bandit Captain** (CR 2) and resolve it fast. That should feel anticlimactic. It is supposed to.
