...
*What it actually is:* there is no BoyBoy McGee. A small, unambitious Lowside gang has been running this exact posting for years, betting that whoever's hungry or bored enough to walk a tin of cookies to a dead-end alley for 20 gold is also broke enough to be worth rolling for whatever's in their pockets. It filters for exactly the kind of crew that can't afford to ignore free money, which is most crews at the bottom of the Board, which is the whole scheme. **They have no idea who they're about to try this on.** Two or three unimpressive toughs, a knife apiece, absolutely not prepared for anyone this crew's actually fought. Play it for comedy, not danger: the gang picked a mark off the Manifest Board rank alone and never checked the Track Record (`ships/Night Fury.md`). *Complication:* whoever answers the posting goes alone or lightly escorted, since it reads as nothing, which is the actual test of the scene, not the fight.
