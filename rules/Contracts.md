...
## Qualifiers (house rule, permanent, use this when writing any new job)

Postings can gate on more than money. Two kinds, and most jobs should carry zero or one, stacking several turns a job posting into a wall:

- **Hard gates.** Printed right on the posting, not negotiable. If the crew doesn't meet one, the Charter Window won't assign it to them, in fiction, not as a DM ruling delivered mid-pitch. A player should be able to read a hard gate off the sheet and rule themselves out (or in) before ever pitching it.
- **Soft gates.** A client's stated preference, not a rule. Talkable past with a good pitch, a reference, a favour, and talking one down is a scene, not a failed check.

**Only called out where it matters.** No qualifier line means open board, anyone can take it, and most Small jobs should stay this way on purpose, a brand-new crew has to be able to earn a living. Where a job's flavor text *reads* like it's over the crew's head, or conspicuously beneath them, that's deliberate: the posting should tip a player off before they commit, the way a real job listing signals its own level without saying so outright.

### What a gate can actually be, and what fits this world

Reach for these before inventing something abstract. Pick whichever a *real client* posting this specific job would actually care about, not whichever sounds toughest:

- **Reputation.** Board rank, a minimum number of completed contracts, a specific person vouching (Senna, Meech, a prior client). The most common gate, and the one that decays fastest as the crew climbs, revisit old postings' framing as the Board rank changes.
- **Hull.** Cargo tonnage, a minimum HP or AC tier, a specific hull class, whether it's armed at all (some discretion jobs want the *opposite* of a warship, an unarmed-looking hull is the actual asset). Checkable against `ships/Night Fury.md` directly.
- **Crew.** A minimum headcount (boarding parties, heavy cargo handling), a specific class or skill aboard (a rogue for a lock, a caster for a ritual, someone who reads Draconic), a piece of gear. This is the gate most worth reaching for, it's a direct excuse to spotlight a specific PC or NPC by name in a job posting before the job even starts.
- **Experience.** Has done the specific thing before: fought a void scavver, boarded a hostile hull, worked a named region. **This is the gate that should show up more as the campaign goes on.** The crew is starting to accumulate real feats (see the Track Record note in `ships/Night Fury.md`), and jobs referencing them by name is the reward for that history existing, this crew and no other gets offered this, because of what they already did.
- **Certification.** A licensed professional aboard, a Nightbreeze bond, a CIV endorsement. Bureaucratic and on-paper, deliberately separate from actual capability, this is the gate that's worth playing as friction (Brass is a superb medic and holds no license; a job that hard-gates on "a licensed physician" locks her out on paper for a thing she's better at than anyone with the paper).
- **Species or biology, rarely, and only when the job's premise actually needs it.** "Someone who doesn't need to breathe," "a water-adapted crew member" for underwater work. Use sparingly, and never as a stand-in for a reputation or skill gate, it should read as a genuine practical requirement of the job, not a checkbox.

**On "founding house bonding," corrected.** That was too vague to actually use at the table. Where a job wants an insurance-backed guarantee, name it: **a Nightbreeze bond**, the founding house that actually underwrites this (`factions/Houses & Holdings.md`). It's concrete, it's a real thing the crew could work toward getting, and it gives Escort's gate below an actual mechanism instead of a hand-wave.
...
**House Prynne**, a tightly-run Chain merchant family, wants their eldest, **Isolde Prynne**, chaperoned to a betrothal meeting at the **Larkspur Concourse**, a marble station two rungs up the social ladder from anywhere this crew has ever docked. *Complication:* patriarch **Osric Prynne** has heard the *Night Fury*'s name from somewhere he won't specify and keeps almost-mentioning it. *(A quiet, low-danger job that puts a founding-house-adjacent stranger at close range right when the crew least wants one. Nothing has to come of it. Something can, if you want it to. Genuinely the safe pick on this rotation.)* Full scene detail: `sessions/Session 3 Prep.md`. **Qualifier:** none, and that's the actual reason they got hired, a nameless, unranked hull is exactly what a family paying to keep this quiet wants. Worth saying so, once, so low rank starts reading as a real asset sometimes, not just a handicap.

> **The Ledger Run and Two Chairs Short moved to Medium, below.** Both grew past a Small job's money and danger while getting written up; see that section rather than the payout table above. **Play this straight with the table**: given a choice they will reach for the biggest number on the sheet almost every time, so both have been calibrated to actually be fair for a level-5 crew that just survived Bex, not a repeat of the Escort mismatch (`rules/Contracts.md`, below) where the payout outran what they could actually take on.
...
**The Ledger Run** · 2,400 gp · 20 days · 5 tons
A Delverane clerk needs a season's worth of survey backlogs hand-carried between two archive stations out along the Windward Edge, because the usual courier route "isn't resolving cleanly" and nobody there wants to say more than that on paper. *Complication:* the *Cutlass Sunday* has been shadowing couriers on this exact stretch since word got around that a ranked-above-them crew got jumped leaving Reefside and won. *Rimmon Vex* wants to know if that was luck. **Real ship-to-ship danger, meant to actually hurt if mishandled, but a fair fight for this crew alone.** Full encounter design: `sessions/Session 3 Prep.md`. **Qualifier (soft):** Delverane wants a clean completed contract on file before they'll hand over a season's data. Sealed and Sworn covers it, and Senna vouching for them personally is doing real work here, worth a line of dialogue rather than a formality.

**Two Chairs Short** · 5,600 gp total, split with the *Quiet Sum*, ~2,800 gp to the crew · 22 days · 4 tons
A small independent outfit lost half its crew mid-contract, doesn't have enough hands left to run a chaperone job solo, and won't give up the fee either, so they're offering to split it for a second hull to run it *with* them, two crews, one job. The full contract is worth a genuine 5,600 gp, which is why it's worth taking even carved in half, the crew's actual cut clears more than either of the other two postings this rotation on their own. *Complication:* it wasn't a rival poaching their people. It's an unmarked boarding hull with grappling jaws working a stretch of the Tollmarch, hitting soft targets and backing off from anyone who fights back, which is exactly what the outfit wasn't equipped to do alone. **The highest-paying option on the board this rotation, and the most dangerous, calibrated to be survivable specifically because it's a joint fight, not a solo one.** Full encounter design: `sessions/Session 3 Prep.md`. **Qualifier:** none printed, but the real reason Trask asked this crew specifically is an experience gate he didn't have to write down. Word travels fast at the bottom of the Board, and a crew who boarded and beat a hostile hull last week (`ships/Night Fury.md`, Track Record) is exactly who a captain worried about a repeat boarding wants standing next to him.

**Dressing the Part** · 2,500 gp · 20 days · 2 tons
A minor noble house needs a **reputable, prestigious charter** to carry the family to a grand event well off the common lanes: a confirmation gala at a marble station, a houses' summit, a season ball where the guest list is the whole point. *Complication:* the crew are 348th on a Board that counts, flying an unnamed, battered hull under a borrowed name. The job is to *pass*. Keep the ranking buried, keep Tack from introducing Deborah to the valet, make the tattered flag read as heritage instead of salvage, and get the family through the doors without anyone asking what the *Vane boat* is doing at a gala. *Spotlight:* Aerion's poise and the family game he plays for real, Oz's flawless manners carrying the whole imposture, and the unnamed-ship bit paying comic dividends. Good money for pure farce, with a real bite if the mask slips. **Qualifier (soft, and the whole premise):** the posting technically asks for "a reputable, established charter." The family's budget doesn't stretch to one, which is the only reason this crew got the call at all, and passing the qualifier in person is the job.

**Salvage Rights** · 4,200 gp · 34 days · up to 20 tons
Recover what's recoverable from a wreck in the Tollmarch. *Complication:* Stoneward claims salvage rights in the Tollmarch and their claim is legally solid and morally nonsense. **Qualifiers:** *(reputation, soft, and it cuts against them)* filing a competing salvage claim carries more weight coming from a higher-ranked hull, at 347th the crew's own claim is the weak one in the room, worth playing as a real disadvantage in the negotiation, not just flavor. *(crew skill, soft)* the hold's old enough to carry real traps and a jammed lock or two; a crew with someone light-fingered aboard (Finny) has genuinely better odds than a broker would expect from this rank, worth letting that be visible in how the job goes.

**The Long Cold** · 5,500 gp · 41 days · 18 tons
Resupply three Verge colonies on one loop. *Complication:* the third colony is not where the chart says. It's four hours off. Nobody can explain it and the colonists have stopped mentioning it to visitors. **First Guttering symptom. Play it as mild confusion.** **Qualifier:** none, but 41 days is close enough to the crew's own self-imposed 60-day air-clock limit that Aerion should do the math out loud before they sign, an in-fiction nudge rather than a rule stopping them.

**Escort** · 6,000 gp · 38 days · 0 tons
Shepherd two unarmed haulers through the Tollmarch. *Complication:* the thing that hits them is a boarding hull with grappling jaws, and it breaks off the moment it sees the crew is armed. It does not want a fight. It wants easy cargo. *(Seed for Aeravellis. Do not explain it.)* **Qualifier (hard, reputation + certification):** Stoneward requires an escort contractor to be Board-ranked in the top 300 or carry a posted **Nightbreeze bond**, printed right on the posting, nothing to do with whether the *Night Fury*'s two ballistae could actually do the job. **Not open to the Vagabonds yet, and it's paperwork keeping them out, not capability.** Let a player notice the line themselves before anyone has to say so out loud; a bond is a concrete thing they could work toward buying into later.

**The Quiet Contract** · 3,800 gp · 30 days · 4 tons
A Nightbreeze factor needs documents delivered by hand to four separate addresses. *Complication:* the fourth address is Aerynna's office and nobody warned Aerion. **Qualifier (soft):** the factor wants a crew "known for discretion." Nothing on paper backs that up yet; it's a pitch Aerion or Brass can sell in person, not a box the crew can check.
...
**Wanted: Lively Entertainer(s)** · pay very generous · same day · negligible
...
*What it actually is:* **House Ashby and House Talvane**, two old-money families a rung below the founding Houses who loathe each other, co-hosting their kids' joint birthday because the children are best friends and insisted. Each secretly hired their own entertainment, Talvane the *Night Fury* crew, Ashby the polished **Lucky Star Revue** (Marchetta Vale, the same rival BoyBoy and Verity Gilt keep company with), and neither told the other. **The houses are the joke, the rival troupe is just along for the ride.** Full posting, both houses, the shape of the farce: `sessions/Episode - Two Houses, One Cake.md`.
...
### Standing (never rotates off the board)

**Open Season** · pay scales with proof · no distance, no destination
A laminated card pinned permanently beside the fresh postings, stamped with a Route Warden seal instead of a client's hand: *"The Concordance maintains open bounty on void-lane predators. Bring proof, collect the standing rate. See posted schedule."* **Qualifier:** none, this is standing work, claimed whenever a scavver crosses the crew's path rather than gone out of the way for.

*What it actually is:* the CIV's official cull program, unglamorous, permanent, and everywhere, the same bounty that's been running for a century and the literal mechanism (`campaign/Story Spine.md`) behind the whole Guttering. Proof is a **fin-clip**: a legitimate kill gets its dorsal fin notched in a pattern unique to the claiming crew, both so nobody double-dips a corpse and so a good hunter's reputation travels with the pattern, small-scale trophy culture, a few regulars at the Compass Rose who compare notches. **The schedule:** Gray Scavver, 5 gp (barely worth the arrow, most crews wave them off); Brown Scavver, 250 gp; Night Scavver, 750 gp; Void Scavver, 10,000 gp and a line in the Manifest Board's incident log, the kind of headline that gets a struggling charter noticed, for better or worse. Play it as unexamined normal work for as long as it can stand it, a bounty board like any other, right up until Tier 2 hands the crew the cascade and they have to sit with how many fins they've already turned in. **Don't force the reckoning.** Let the standing rate just keep sitting there on the board, ordinary and available, so the day it stops reading as ordinary is the crew's own realization, not a lecture.

---

# PART 2 — THE TIER 1 SPINE

Eight missions, levels 5 to 8, in order. Space them with two or three Jobs apiece. Each one plants something the rest of the campaign needs.
...
**What it plants:** the search is real, findable, and ongoing. It also produces the first **account of what happened**, which will later contradict the second one.
**Do not resolve anything.** They know one more thing and one fewer person is missing.

> Who this is belongs to Gabrielle. Use whoever she named first at session 0 #1.

---

## M4 — THE DELISTED ROUTES (level 6–7)
Follows the breadcrumb behind the Charter Window: **Deputy Registrar Meech has noticed three frontier routes quietly delisted last year with no incident reports attached.** It bothers him. He'll say so to anyone who asks a well-formed question.

**What happens:** the crew flies one of the delisted routes. It doesn't go anywhere any more. The port at the end of it is a day and a half from where it should be, and the people living there have stopped mentioning it to visitors because the last three ships to hear about it didn't come back.

**What it plants:** the first evidence that this is a *pattern* rather than an error. Senna Orrick pays premium for the report and looks at them differently afterward.
...
**What it plants:** the most dangerous relationship in the campaign. Priscilla will know exactly what's happening and take the help anyway, because it's good help and refusing it costs money they don't have.
**The bill arrives in Tier 2.**

---

## M6 — WHAT BOARDED THE *KETTLE* (level 7–8)
The Weatheralls' hauler out of rank 345 limps into Bral with grappling scars on her flank, cargo gone, and nobody hurt because they didn't resist. Nineteen people aboard, four of them children.
...
## M7 — THE AUDIT (level 8)
Priscilla's mission, and it's fought entirely on paper.
